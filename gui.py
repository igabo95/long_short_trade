...
def create_long_position_window(root):
    # Carica l'immagine
    img = Image.open("long.png")  # Assicurati che l'immagine si trovi nella root directory
    ...
    tk.Label(root, text="Top Price Prediction    Pt =", bg='black', fg='white').grid(row=3, column=0, sticky='e', padx=5, pady=5)
